...
(deftest vdc-tests
  (is (= (take 4 (vdc/vdc-unscr 2)) [1/2 1/4 3/4 1/8]))
  (is (every? #(< 0 % 1) (take 1000 (vdc/vdc-unscr 29))))
  (is (every? #(< 0 % 1) (take 1000 (vdc/vdc [0 3 1 4 2] 5))))
  (is (= (take 4 (vdc/vdc-unscr 2)) (vdc/vdc-unscr 2 4))))

(deftest halton-tests
  (is (= (take 4 (halton/halton-unscr [2 3])) [[1/2 1/3] [1/4 2/3] [3/4 1/9] [1/8 4/9]]))
  (let [h (take 1000 (halton/halton [[0 2 1] [0 4 2 3 1]] [3 5]))]
